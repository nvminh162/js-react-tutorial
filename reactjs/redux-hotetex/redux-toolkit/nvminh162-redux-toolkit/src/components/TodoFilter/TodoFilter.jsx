...
import { todoFilterSlice } from './todoFiltersSlice'
...
function TodoFilter() {
  ...
  const handleStatusChange = (e) => {
    ...
    dispatch(todoFilterSlice.actions.statusFilter(e.target.value));
  };
  ...
  const handlePriorityChange = (e) => {
    ...
    dispatch(todoFilterSlice.actions.priorityFilter(newPriorities));
  };
